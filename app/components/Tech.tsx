...
const TechBox = ({ title, icon, list }: TechBox) => {
  return (
    <div className="bg-secondary shadow-box h-[370px] lg:w-[300px] md:w-[250px] w-full md:px-8 px-4 py-4 m-2 rounded-lg">
...
const Tech = () => {
  ...
  return (
    <div className="bg-secondary bg-opacity-95 text-base">
      <Container>
        <div className="my-20">
          <div className="text-5xl font-bold text-center pb-8">
            Skills & Tools
          </div>
          <div className="flex md:flex-row flex-col justify-center items-center lg:gap-12 md:gap-2 gap-1">

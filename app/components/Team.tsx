    ...
    <Container addStyles="bg-secondary">
      <div className="p-4 pb-24 flex justify-center flex-col items-center">
        ...
        <p className="text-xl py-4">
          ...
          first year of college on "FH Technikum Vienna" where i also graduated
          in "Information and Communication Systems". After one year in college
          I had the opportunity to work at ecosio. This was my first IT job
          ever. In 2017 for the first 6 months I started as a website admin and
          switched after to the frontend department until 2022.
        </p>
      </div>
    </Container>
  );

const Projects = () => {
  return (
    <div>
      <h1 className="text-5xl font-bold mb-4">Project Stories</h1>
      ...
      <div className="border-2 back bg-teal-500/75">
        ...
        <p className="text-xl">
          I had the privilege of working at ecosio GmbH, where we offered exceptional EDI and e-invoicing software solutions as a service. My journey with ecosio began in 2017, initially with simple tasks like adding content and enhancing the visual appeal of their website. It was an enjoyable experience as I had the freedom to express my creativity since no designer was involved at the time. Infusing the website with my personal touch was always fun.
          As time went on, I became a valuable member of the frontend team, contributing to the development of their first supplier relationship management tool. However, the most exciting project I worked on was the creation of the EDI monitor tool, which boasted captivating animated graphs. I take great pride in having developed this tool, as it effectively visualizes all EDI traffic for their customers.
          As my responsibilities grew, I found myself involved in additional tasks such as maintaining internal React component libraries, building a theme switch tool for our customers, and implementing a localization tool. ecosio not only provided me with my first job as a developer, but also offered me a platform to learn and grow. I am immensely grateful for the years I spent at ecosio, as they have played a pivotal role in shaping my career as a developer.
        </p>
      </div>
    </div>
  );
